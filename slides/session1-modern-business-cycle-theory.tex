...
\end{itemize}
\vfill\key{Handout:} Chapter 1 \quad \key{Code:} \texttt{chap1/codes/}
\end{frame}
\section{What is a cycle?}
\begin{frame}{Observed output combines several objects}
\centering\begin{tikzpicture}[node distance=1.1cm,>=Latex]
...
\centering\begin{tikzpicture}[node distance=.8cm,>=Latex,every node/.style={draw,rounded corners,align=center,minimum height=.75cm,fill=gray!8}]
