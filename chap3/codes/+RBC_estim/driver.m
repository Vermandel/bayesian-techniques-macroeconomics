...
M_.param_names(1) = {'rho_A'};
M_.param_names_tex(1) = {'rho\_A'};
M_.param_names_long(1) = {'rho_A'};
...
M_.param_names(5) = {'Kss'};
M_.param_names_tex(5) = {'Kss'};
M_.param_names_long(5) = {'Kss'};
M_.param_names(6) = {'Css'};
M_.param_names_tex(6) = {'Css'};
M_.param_names_long(6) = {'Css'};
...
M_.params(4) = .4;
alpha = M_.params(4);
M_.params(5) = ((1/M_.params(2)-(1-M_.params(3)))/M_.params(4))^(1/(M_.params(4)-1));
Kss = M_.params(5);
M_.params(6) = M_.params(5)^M_.params(4)-M_.params(3)*M_.params(5);
Css = M_.params(6);
...
estim_params_.var_exo = [estim_params_.var_exo; 1, .007, NaN, Inf, 0, NaN, NaN, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 1, .95, NaN, NaN, 0, NaN, NaN, NaN, NaN, NaN ];
...
title('Capital')
save('RBC_estim_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('RBC_estim_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('RBC_estim_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('RBC_estim_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('RBC_estim_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('RBC_estim_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('RBC_estim_results.mat', 'oo_recursive_', '-append');
end
